define(['angular', 'underscore', 'moment', 'app/meetings/meetingsDay', 'app/settings/settingsService','cookies'],
    function (angular, _, moment, meetingsDayFile, settingsServiceFile,cookies) {
