        ...
        return {
            ...
            controller: function ($scope) {
                ...
                $scope.clickRegistration = function () {
                    var withPublic = window.location.href.substring(7).substring(window.location.href.substring(7).indexOf("/")+1).substring(0,window.location.href.substring(7).substring(window.location.href.substring(7).indexOf("/")+1).indexOf("/"));
                    var indexPublic = withPublic.indexOf('public');
                    var nameAgendaDB = withPublic.substring(0,indexPublic);
